...
<div className="contact-container">
    <button data-aos="fade-up" className="btnContact mb-3">
      Contactame <i className="fa-solid fa-paper-plane"> </i>
    </button>
    <div className="contactos">
      <Link
        to={"mailto:chavezpedrito04@gmail.com"}
        target="_blank"
        className="m-3 text-decoration-none"
      >
        <button className="contactButtonMail">
          <svg
            className="me-2"
            height="20"
